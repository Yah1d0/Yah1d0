...
- 🎓 **Self-taught developer** with a build-by-doing approach (coding since 2025).
...
- **Tech:** Tauri, Svelte, TypeScript.
- **Status:** Currently corewriting and redesigning the architecture.

### 🛒 [Store Website](https://github.com/Yah1d0/Store-website)
*Full-stack web application exploring backend patterns.*
